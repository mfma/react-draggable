...
export function createDraggableData(draggable: Draggable, coreData: DraggableData): DraggableData {
	...
	return {
		node: coreData.node,
		x: draggable.state.x + coreData.deltaX/parentScale,
		y: draggable.state.y + coreData.deltaY/parentScale,
		deltaX: coreData.deltaX/parentScale,
		deltaY: coreData.deltaY/parentScale,
